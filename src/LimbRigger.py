...
importlib.reload(MayaUtilis)

from PySide2.QtGui import QColor
from PySide2.QtWidgets import QColorDialog, QHBoxLayout, QLabel, QLineEdit, QMessageBox, QPushButton, QSlider, QVBoxLayout, QWidget  #here we're just importing / downloading what we need to make certain funtions witin our code work properly
